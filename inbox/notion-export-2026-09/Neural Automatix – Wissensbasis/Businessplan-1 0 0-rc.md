...
| 19.09.2026 (Europe/Berlin), 2. Runde | 1.0.0-rc | Wissensmanagement-/RAG-Infrastruktur (PostgreSQL/pgvector, Docker-Multi-Agenten-Setup) als eigenständiges Zusatzangebot in Säule 2 ergänzt; didaktisches Grundprinzip Einstieg–Erarbeitung–Sicherung dokumentiert; neuer Abschnitt "Use Cases je Säule" (Chatbot als Türöffner, Meisterschule/IHK-Schulungs-Use-Case, Industrie-Simulationsmodell mit Sensorik/Aktorik); Markteintrittsplan Europa-vor-Deutschland (Benelux/Niederlande, EU-Institutionen als Langfristoption, Sprachrollout EN/FR zuerst) ergänzt; neuer Abschnitt Marketing-Strategie (Nachfrageorientierung, Agentic Marketing, Chatbot als Vertriebs-Türöffner) |
...
**Europa vor Deutschland – Markteintrittsplan (ergänzt 19.09.2026).** Die Marktpriorität liegt bewusst nicht auf Deutschland, sondern auf dem europäischen Wirtschaftsraum, beginnend mit Luxemburg/Benelux und den Niederlanden (siehe oben) als naheliegendstem, großem und adoptionsstarkem Zielmarkt (33,2 % KI-Nutzung, M16) – Deutschland bleibt zusätzlicher, größerer Sekundärmarkt. Konkrete Schritte vor Markteintritt: (1) Nachfrageprüfung nicht nur auf freelancermap.de, sondern auch auf vergleichbaren Projekt-/Freelance-Portalen im niederländisch-/Benelux-Sprachraum (Portalnamen sind vor Einreichung noch zu identifizieren und zu belegen – offener Punkt); (2) Zielgruppenerweiterung um Industrieunternehmen in der Grenzregion sowie – als Langfrist-/Sondierungsoption – EU-Institutionen und Behörden mit Digitalisierungs-/KI-Bedarf; (3) internationale Sprachausrichtung, beginnend mit Englisch und Französisch (Kernsprachen Luxemburg/Belgien/Niederlande-Geschäftsverkehr), mit späterer Erweiterung um weitere EU-Sprachen je nach Nachfrageentwicklung. Diese Reihenfolge ist eine strategische Priorisierung, keine belegte Marktprognose; die Nachfrageprüfung nach Punkt (1) ist Voraussetzung, bevor Ressourcen in weitere Sprachen oder Kanäle investiert werden.
...
**Wissensmanagement- & RAG-Infrastruktur (eigenständiges Zusatzangebot innerhalb Säule 2, ergänzt 19.09.2026).** Prozessberatung beim Aufbau kompletter KI-Systemlandschaften für Kunden: Zerlegung und Aufbereitung von Unternehmenswissen in strukturierte Datenbanken, Aufbau von Wissensdatenbanken und Retrieval-Systemen (RAG) auf Basis von PostgreSQL mit der Vektorerweiterung **pgvector** als Embedding-Speicher, Bereitstellung der Multi-Agenten-Infrastruktur über **Docker**-Container für reproduzierbare, verteilte Systemlandschaften. Fokus auf lokale, DSGVO-konforme Modelle für datenschutzsensible Kunden, ergänzt um Cloud-Modelle für anspruchsvollere Aufgaben (siehe Technisches Grundkonzept, BP-ARCHITEKTUR-0001). Nachweis/Proof of Concept: Der Gründer hat sein eigenes Wissens- und Managementsystem (diese Notion-/Repo-Wissensbasis) nach demselben Prinzip aufgebaut – Zerlegung, Strukturierung und Ablage von Fachwissen in Datenbanken – und nutzt es als eigenes Referenzsystem (siehe DTO-Vision, BP-VISION-0001). Dieses Angebot verbindet Säule 1 (Systemintegration/Datenbanken) und Säule 3 (Wissensvermittlung) technisch und ist damit ein Beleg für den Grundsatz "eigenes Werkzeug ist erster Kunde".
...
**Didaktisches Grundprinzip (ergänzt 19.09.2026, aus dem Lehramts-Hintergrund des Gründers).** Alle Schulungsformate folgen dem etablierten Dreischritt **Einstieg – Erarbeitung – Sicherung** und werden zielgruppen- und altersgerecht aufbereitet (z. B. Werkstattsprache und Praxisbeispiele für gewerbliche Fachkräfte vs. konzeptionelle Tiefe für Führungskräfte). Dieses Prinzip ist nicht nur Theorie, sondern durch die laufende Lehramtstätigkeit (siehe BP-GRUENDER-0001) unmittelbar erprobt.
...
## Use Cases je Säule (Markteinstieg, ergänzt 19.09.2026)

ID: BP-USECASES-0001

Konkrete Einstiegs-Use-Cases pro Säule, mit dem Chatbot als übergreifendem Türöffner:

- **Chatbot als Türöffner (alle Säulen).** Chatbots sind einzeln nachweisbar stark nachgefragt (siehe M11/M12: KI-Projektnachfrage-Wachstum und aktive KI-Nutzung, BP-MARKT-0001) und eignen sich als niedrigschwelliges Erstprodukt: geringer Erklärungsaufwand für den Kunden, schneller sichtbarer Nutzen, guter Aufhänger für ein Erstgespräch. Varianten: Website-/Support-Chatbot (Säule 2), interner Wissens-Chatbot (Säule 3), sowie ein **eigener Telefonanschluss mit Voice-Agent** (Säule 2, "Voice-Agent Starter") als Demonstrationsobjekt im eigenen Vertrieb – der Gründer nutzt das eigene Angebot als ersten Referenzkunden.
- **UC Aus-/Weiterbildung auf IHK-/Meisterschule-Basis (Säule 3).** Aufbau eines Schulungs-Use-Case für die berufliche Fort-/Weiterbildung (Meisterschule Metall / IHK-Kontext, siehe separate Inhaltsarchitektur "Meisterschule Metall" in der Wissensbasis), angewendet nach dem Prinzip Einstieg–Erarbeitung–Sicherung; dient als vorzeigbares Referenzprojekt für Bildungsträger und IHK-Kontakte.
- **UC Industrie-Simulationsmodell (Säule 1).** Physisches Demo-/Referenzmodell mit Sensorik und Aktorik (Lego Mindstorms, Calliope Mini, ggf. Arduino und Raspberry Pi, optional Drohnen-Plattformen als Sensor-/Aktor-Erweiterung) zur anschaulichen Vorführung von Systemintegrationskompetenz ohne Kundendaten – Erweiterung des bestehenden Referenz-Use-Case-Ansatzes (siehe use-cases-referenz.md und DTO-Vision, BP-VISION-0001).
- **UC Wissensbasis/RAG (Säule 2, siehe oben).** Das eigene, mit PostgreSQL/pgvector aufgebaute Wissensmanagementsystem dient zugleich als Kunden-Demo für die Wissensmanagement-Infrastruktur.

Einschränkung: Diese Use Cases sind Konzeptbausteine für den Markteinstieg, keine abgeschlossenen Kundenprojekte; vor Einreichung sind sie ggf. um 1–2 konkret durchgerechnete Beispiele zu ergänzen (siehe offene Punkte, BP-MARKT-0001).
...
## Marketing-Strategie (ergänzt 19.09.2026)

ID: BP-MARKETING-0001

**Nachfrageorientierung als Grundprinzip.** Angebote werden nicht aus technischer Machbarkeit heraus entwickelt, sondern an tatsächlich nachgewiesener Nachfrage ausgerichtet (siehe Marktbelege M1–M18, BP-MARKT-0001, und die Nachfrageprüfung im Markteintrittsplan oben). Was nachweisbar gesucht wird – allen voran Chatbot-/Automatisierungslösungen – wird priorisiert vor Angeboten ohne belegte Nachfrage.

**Content-/Agentic-Marketing.** Markenaufbau über eigene, KI-gestützt erstellte und automatisiert veröffentlichte Social-Media-Inhalte ("Agentic Marketing"): Das Unternehmen wendet die eigene Kernkompetenz (KI-Agenten-Orchestrierung, Säule 2) auf das eigene Marketing an und macht den Prozess selbst zum Referenz-/Demo-Case. Alle so erstellten Inhalte werden gemäß Transparenzpflicht als KI-generiert gekennzeichnet (siehe BP-COMPLIANCE-0001).

**Chatbot als Türöffner im Vertrieb.** Der eigene Website-/Telefon-Chatbot (siehe BP-USECASES-0001) dient nicht nur als Produkt-Demo, sondern aktiv als Erstkontakt- und Lead-Qualifizierungskanal.

Einschränkung: Dies ist eine strategische Marketingausrichtung, kein durchgerechneter Marketingplan mit Budget/KPIs; Budgetierung erfolgt im Finanzplan (Kapitel 3/3a, Position "Akquise-Kosten/Monat").
